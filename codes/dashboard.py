...
prediction_data = pd.read_csv("C:\\Users\\USER\\Documents\\P7dataset\\files\\features_test.csv")
#prediction_data = prediction_data.drop(columns='AmtIncomeTotal')
# loading the client info file prepared in modeling code
client_info = pd.read_csv('C:\\Users\\USER\\Documents\\P7dataset\\files\\test_client_info.csv')
...
def get_shap_data():
    ...
    pickle_in = open('C:\\Users\\USER\\Documents\\P7dataset\\files\\mlflow_model_0\\model.pkl', 'rb') # load no-threshold model for shap computation
    model = pickle.load(pickle_in)

    train_sample = pd.read_csv('C:\\Users\\USER\\Documents\\P7dataset\\files\\features_train.csv')
